...
<form action="" method="${requestScope.formMethod}">
    ...
    <input ${requestScope.formMethod == "post" ? "disabled":""}
            ...
            "${(requestScope.proposta == null || requestScope.formMethod == "post"?"":requestScope.proposta.status)}"><br>
    ...
    <input ${requestScope.formMethod == "delete" ? "disabled":""}
            type="number"  id="valor" name="valor" value="${requestScope.proposta == null ?"" :requestScope.proposta.val}"<br>

    <label for="cpf">CPF:</label><br>
    <input ${requestScope.formMethod == "delete" ? "disabled":""}
            type="text" id="cpf" name="cpf" value="${requestScope.formMethod == "post" || requestScope.proposta == null?"":requestScope.proposta.cpf}"<br>

    <label for="cnpj">CNPJ:</label><br>
    <input ${requestScope.formMethod == "delete" ? "disabled":""}
            type="text" id="cnpj" name="cnpj" value="${requestScope.formMethod == "post" || requestScope.proposta == null?"":requestScope.proposta.cnpj}"<br>

    <label for="carro_id">Carro_Id:</label><br>
    <input ${requestScope.formMethod == "delete" ? "disabled":""}
            type="text" id="carro_id" name="carro_id" value="${requestScope.formMethod == "post" || requestScope.proposta == null?"":requestScope.proposta.carro_id}"<br>
